...
class AirLLMLlamaMlx:
    ...
    def __init__(
        ...
        **kwargs,
        ...
        config_kwargs: dict = {"trust_remote_code": self.trust_remote_code}
    ...
    def get_tokenizer(self, hf_token=None):
        tok_kwargs: dict = {"trust_remote_code": self.trust_remote_code}
        if hf_token is not None:
            tok_kwargs["token"] = hf_token
        return AutoTokenizer.from_pretrained(self.model_local_path, **tok_kwargs)
