#!/usr/bin/env bash
# =============================================================================
# Anima 100K longer-context training script.
#
# This is a research/training utility, separate from the core AirLLM inference
# library. It fine-tunes a 7B model for 100K context length using
# FlashAttention2, XEntropy, and paged 8-bit Adam optimizations.
# =============================================================================
