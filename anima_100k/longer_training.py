...
"""Anima 100K longer-context QLoRA training script.

This is a research/training utility, separate from the core AirLLM inference
library. It fine-tunes LLaMA-based models for 100K context length using
FlashAttention2, XEntropy, and memory-optimized training techniques.
"""
...
def get_accelerate_model(args, checkpoint_dir):
    ...
    logger.info("model.config.torch_dtype: %s", model.config.torch_dtype)
