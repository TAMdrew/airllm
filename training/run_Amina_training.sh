#!/usr/bin/env bash
# =============================================================================
# Anima 33B QLoRA training script.
#
# This is a research/training utility, separate from the core AirLLM inference
# library. It reproduces the Anima 33B model training on a single H100 GPU
# or dual A100 40GB GPUs.
# =============================================================================
...
# Token length distribution from ./test_cn_dataset_lenghts.py:
#   source len @qt0.8: 188.0    target len @qt0.8: 222.0
#   source len @qt0.85: 228.0   target len @qt0.85: 267.0
#   source len @qt0.9: 297.0    target len @qt0.9: 342.0
#   source len @qt0.95: 396.0   target len @qt0.95: 491.0
#   source len @qt0.98: 515.0   target len @qt0.98: 670.28
...
python qlora.py --dataset="chinese-vicuna" \
    ...
    --max_steps 10000 `# QLoRA paper appendix B Table 9`\
    --model_name_or_path "timdettmers/guanaco-33b-merged" \
    --source_max_len 512  `# covers ~98th percentile of source lengths  `\
